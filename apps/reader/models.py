...
class NIC(models.Model):
    nic_numbber = models.CharField(max_length=10, primary_key=True)
    delivery_date = models.DateField()
    # auto-calculated field from other fields
    # expiration_date = models.DateField or 
    ...
    def __str__(self) -> str:
        return f'{self.nic_numbber} (deliv: {self.delivery_date}, exp: {self.expiration_date})'
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                # reader_Reader_title_check # name='reader_Reader_title_check'
